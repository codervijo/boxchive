...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:site_name", content: "Boxchive" },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:site", content: "@boxchive" },
    ],
    links: [
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          name: "Boxchive",
          description:
            "Boxchive turns phone photos of old paper documents into a searchable, organized digital archive for museums, historical societies, law firms, churches, and libraries.",
        }),
      },
    ],
  }),
